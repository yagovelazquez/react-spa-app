...
function ProfileSectionTitle(props) {
  const {
    ...
    headingProperties,
    subHeadingProperties,
  } = props;
  const defaultHeadingProperties = {
    fontWeight: "100",
    fontSize: "2xl",
    letterSpacing: "0.25rem",
  };
  const defaultSubheadingProperties = {
    variant: "normalText",
    fontSize: "lg",
    letterSpacing: "0.028rem",
  };

  const finalHeadingProperties = headingProperties
    ? headingProperties
    : defaultHeadingProperties;
  const finalSubHeadingProperties = subHeadingProperties
    ? subHeadingProperties
    : defaultSubheadingProperties;
